...
var SpaceAge = exports.SpaceAge = function () {
  ...
  _createClass(SpaceAge, [{
    ...
    value: function convertStringToDate() {
      var moment = require('moment');
      var date = moment(this.dateOfBirth);
      return date;
    }
  }, {
    key: 'getCalculatedDateInSeconds',
    value: function getCalculatedDateInSeconds() {
      var date = this.convertStringToDate();
      var currentDateTime = (0, _moment2.default)();

      var covertedDate = currentDateTime.diff(date, 'seconds');

      return covertedDate;
    }
  }, {
    key: 'getEarthAge',
    value: function getEarthAge() {
...
},{"./../node_modules/moment/moment.js":2,"moment":2}],2:[function(require,module,exports){
//! moment.js
//! version : 2.18.1
...
var _galacticAge = require('./../js/galacticAge.js');
